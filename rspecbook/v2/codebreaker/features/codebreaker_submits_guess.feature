Feature: code-breaker submits guess
  ...
  Each position in the secret code can only be matched once. For example, a guess of 1134 against a secret code of 1234 would get three plus signs: one number match in the second position would be ignored.
